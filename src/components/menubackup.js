 // const renderMenuItems = (section) => {
  ...
  //               <li>French Onion Soup - Carmelised Onion, White Wine, Port, Beef Stock, Gruyere, Bagel Crostini (Seasame Seed) - $12</li>
  ...
  //               <li>Beetroot and Burrata - Roasted and Marinated Beets, Olive Oil, Sherry and Cider Vinegar, Spaices + Herbs + Maldon Salt - $23</li>
  ...
  //               <li>Hummus + Pita - Chickpeas, Tahini, Olive Oil, Parsley, Lemon uice, Zaatar, Preserved Lemon, Hot Pepper Spread - $21</li>
  //             </ul>
  //         </>
  //       );
  //     case 'pizzas':
  ...
  //               <li>Pancetta And Smoked Provolone - Fior Di Latte, Squash, Pancetta, Smoked Provolone - $21</li>
  //               <li>Capricciosa - Tomato Sauce, Fior Di Latte, Ham, Mushroom, Artichoke, Moroccan Black Olives - $21</li>
  //               <li>Porcini - Fior Di Latte, Squash, Porcini and Radicchio, Parmesan - $21 </li>
  ...
  //               <li>Truffle and Sausage - Fior Di Latte, House Sausage, Tartufata, Parsley - $23</li>
  //               <li>Chanterelles Supreme Deluxe - Chanterelles Mushrooms, Ezzo Pepperoni, Green Peppers, Tomato Sauce, Fior Di Latte - $21</li>
  ...
  //               <li>Flammkuchen - Creme Fraiche, Bacon, Onoin, Gruyere, Parsley, Nutmeg, Black Pepper - $21</li>
  ...
  //               <li>Lobster Roll - Lobster, Avocado, Mayo, Herbs, Lemon Juice, Radish and Lettuce - $25</li>
  //               <li>Rainbow Trout - Celery Root Puree, Brasied Leeks and Heirloom Carrots, Parsley and Capers - $32</li>
  ...
  //               <li>Steak Frites - 10 oz Angus Striploin, Hand Cut Russet Fries, Red Wine Sauce - $40</li>
  ...
  //               <li>Veggie Burger - Bean, Oat, Lentil, Quinoa, Mixed Mushroom, Miso - $19</li>
  //               {/* <li>Lamb Skewers - Lamb Belly (Porchetta Style), Zucchini, Green Pepper, Red Onion, Herb Aioli, White Sauce - $20</li> */}
  //               <li>Shepherd's Pie - Braised Lamb, Onions, Carrot, Duchess Patatoes, Gravy - $23</li>
  ...
  //               <li>Apple Crumble - Ontario Apples, Oats, Butter, Creme Fraiche - $12</li>
